...
The original data source was provided by SchoolVaxView, a service by the Centers for Disease Control and Prevention which publishes data, information and news about US school vaccination coverage based on reports received from individual states. 
...
The data was transformed as follows: 
1. In excel: Deleted all columns not related to diseases othe than measles
...
8. Wrote python programme csv_to_dict2.py to turn data in vaccine_coverage_filtered.csv into a json file, and save resulting dictionary in relevant_coverage.json 
